...
sub Read_Config {
	...
	# Standard, Mandrake and Debian package :	"/home/alphen/domains/alphen.openstad.draad.nu/awstats/.data"
	# Other possible directories :				"/usr/local/etc/awstats", "/etc"
	# FHS standard, Suse package : 				"/etc/opt/awstats"
	my $configdir         = shift;
	my @PossibleConfigDir = (
			"$DIR",
			"/home/alphen/domains/alphen.openstad.draad.nu/awstats/.data",
