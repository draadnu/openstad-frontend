...
module.exports = function createConfig(widget, data, jwt, apiUrl) {
  ...
  let config = {
    ...
    enableAddressSearchClickEvent: widget.enableAddressSearchClickEvent,
    api: {
      url: apiUrl,
    ...
    typesFilterLabel: widget.typesFilterLabel,
      ...
      polygon: ( data && data.global && data.global.mapPolygons ) || undefined,
      polygonStyle: {
        color: widget.polygonColor || '#d00',
        fillColor: widget.polygonFillColor || '#000',
        fillOpacity: widget.polygonFillOpacity || 0.15
      },
