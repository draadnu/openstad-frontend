  ...
  construct: function(self, options) {
    ...
    options.arrangeFields = (options.arrangeFields || []).concat([
      ...
      },
      {
        name: 'map',
        label: 'Kaart',
        fields: ['mapVariant', 'mapAutoZoomAndCenter', 'mapClustering', 'mapMaxClusterRadius', 'canSelectLocation', 'enableAddressSearchClickEvent']
      },
      {
        name: 'map',
        label: 'Polygon',
        fields: ['polygonColor', 'polygonFillColor', 'polygonFillOpacity']
      },
      {
        name: 'content',
        label: 'Content',
      ...
      },
      {
        name: 'search',
        label: 'Zoek balk',
        fields: ['addressSearchCity']
      },
      {
        name: 'idea-form',
        label: 'Idee formulier',
        fields: ['formUrl', 'formFields', 'redirectAfterSubmitIdea']
      },
    ]);
