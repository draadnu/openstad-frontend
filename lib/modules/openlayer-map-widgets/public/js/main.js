var nlMapsHolder = document.getElementById('nlmaps-holder-ideas-on-map');
...
if (!!nlMapsHolder) {
    ...
    var opts = {
        style:   'standaard',
        target:  'nlmaps-holder-ideas-on-map',
        center:  {
            longitude: centerLng,
            latitude:  centerLat
        },
...
// the quick-changing holder of last touchmove y
    ...
    var div            = document.getElementById('nlmaps-holder-ideas-on-map')
