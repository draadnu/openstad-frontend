...
function updateList() {
  ...
  // document.querySelector('#ideaList').innerHTML = newList.innerHTML;
	...
	if (!list.hasChildNodes()) {
		...
		tempLi.className = "gridder-list idea-item";
		tempLi.style.cssText = 'width: 100% !important; text-align: center;';
		
		
		var tempH3 = document.createElement('h3');
		tempH3.style.cssText = 'font-size: 16px; font-weight: 400;'
		tempH3.innerHTML = 'Er zijn geen plannen voor dit thema doorgegaan naar de stemfase.'
		
		tempLi.appendChild(tempH3);
