  ...
  construct: function(self, options) {
    ...
    const superLoad = self.load;
        ...
        widget.ideas = req.data.ideas.map((idea) => {
          if (widget.mapCustomStatuses && widget.customStatusMapping.includes(idea.status) && widget['map' + idea.status]) {
            idea.mappedStatus = widget['map' + idea.status];
          } else {
            idea.mappedStatus = idea.status;
          }
