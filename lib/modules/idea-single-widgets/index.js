          ...
          widgets.forEach((widget) => {
              ...
              if (idea && idea.extraData && idea.extraData.video) {
                ...
                if (video.includes('youtube.com') && video.includes('?v=')) {
                  const videoCode = video.substr(video.lastIndexOf('?v=') + 3);
                  
                  if (videoCode) {
                    widget.embeddedVideo = '<iframe width="560" height="315" src="https://www.youtube.com/embed/' + videoCode + '" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
                  }
                }
              }
