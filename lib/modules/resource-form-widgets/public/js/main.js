...
if (fieldsetElement || fieldsetElementFile) {
  ...
  var pondEl = null;
  if (fieldsetElement) {
    pondEl = fieldsetElement.querySelector('.filepond--root');
  }
}
...
$(document).ready(function () {
  ...
  if (ideaForm && (fieldsetElement || fieldsetElementFile)) {
  ...
  if (ideaForm) {
    ...
    var validator = $(ideaForm).validate({
      ...
      rules: {
        ...
        themevalidation: {
          required: function (element) {
            var boxes = $('input.checkbox-theme');
      ...
      messages: {
        themevalidation: "Dit is een verplicht veld. Vul het alsjeblieft in!"
      },
      submitHandler: function(form, event) {
        
        var $submitButton = $(event.originalEvent.submitter);
        var submitType = $submitButton.data('submit-type');
