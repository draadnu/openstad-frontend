const fields = [
    ...
    },
  {
        ...
        help: 'The url to redirect to after saving the form, it\'s possible to redirect to newly created item (replace with correct url) /pagename/:id   ',
        required: true
    },
    {
      name: 'preFormText',
          ...
          schema: [
            {
              ...
              choices: [
                  ...
                  },
                  {
                    value: 'file',
                    label: "File",
                    showFields: ['fieldKey', 'fieldRequired', 'fieldButtonLabel',]
                  },
                  {
                      value: 'map',
                      label: "Map",
                  ...
                  },
                  {
                    value: 'custom',
                    label: "Custom",
                    showFields: ['rawInput', 'fieldRequired']
                  },
                  {
                      value: 'vimeo',
                      label: "Vimeo",
