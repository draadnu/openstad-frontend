...
const statusCheckboxValues  = require('../../../../config/statusOptions.js').statusCheckboxValues;
...
const fields = [
  ...
  {
    name: 'allowExtraVotes',
    type: 'select',
    label: 'Allow extra votes',
    choices: [
      {
        label: 'No',
        value: 'no',
      },
      {
        label: 'Yes',
        value: 'yes',
        showFields: [ 'extraVoteCount' ]
      },
    ]
  },
  {
    name: 'extraVoteCount',
    label: 'Amount of extra votes to be cast',
    type: 'integer',
    min: 1,
    max: 10,
    required: true
  ...
  {
    type: 'string',
    label: 'BUSY status label in filter',
    name: 'busyStatusFilterLabel'
  },
  {
    type: 'boolean',
    name: 'filterIdeasByTheme',
    label: 'Enable filter by theme'
  },
  {
    type: 'checkboxes',
    name: 'showIdeasByStatus',
    label: 'Show only following ideas with status:',
    choices: statusCheckboxValues
  },
  {
    type: 'boolean',
