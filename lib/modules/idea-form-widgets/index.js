  ...
  construct: function(self, options) {
   ...
   self.route('post', 'submit', function(req, res) {
     ...
     if (req.body.action && (req.body.action === 'UPDATE_STATUS' || req.body.action === 'MODBREAK') ) {
       ...
       data.extraData = pick(req.body, 'theme', 'area', 'advice', 'phone', 'estimate', 'role', 'englishCommunication', 'isOrganiserQuestion', 'isOrganiserName', 'isOrganiserWebsite', 'helpNeededQuestion', 'helpNeededDescription', 'helpNeededApply' , 'isOrganiserPhone', 'isOrganiserEmail', 'vimeoId', 'accessible_location');
