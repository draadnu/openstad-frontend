    ...
    construct: function (self, options) {
        ...
        self.load       = (req, widgets, callback) => {
            widgets.forEach((widget) => {
                ...
                const siteConfig = globalData.siteConfig;
        ...
        /**
         * Return the input type choices for the 'inputType' select in this widget.
         * This function determines if there is already a location picker selected
         * if so, we no longer show the location picker for the 'inputType' select
         *
         * @param req
         * @returns {array}
         */
        self.inputTypeChoices = function (req) {
            if (!req.body.arrayItems) {
                return [];
            }
            ...
            if (!self.hasLocationPickerSelected(req)) {
                choices.push(
                    {
        ...
        /**
         * Check whether or not we have a location picker selected
         * based on the current request
         *
         * @param req
         * @returns {boolean}
         */
        self.hasLocationPickerSelected = function (req) {
            return req.body.arrayItems && req.body.arrayItems.filter((item) => {
                return item.inputType === 'location-picker';
            }).length > 0;
        }
