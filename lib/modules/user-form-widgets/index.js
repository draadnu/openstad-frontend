      ...
      widgets.forEach((widget) => {
        if (widget.containerStyles) {
          ...
          if(widget.linkedToIdea) {
            ...
            console.log ('===< IDEA', ideaId, idea);
            
            widget.hideForm = false;
            
            if ((idea && req.data.openstadUser && idea.userId == req.data.openstadUser.id && !req.data.isAdmin) || !idea || idea.status == 'DRAFT') {
          ...
          widget.getDisplayTitle = function (title) {
            ...
            widget.replacePlaceholderVariables = function (placeholder) {
              ...
              console.log ('replace placeholder variables', idea);
