...
module.exports = {
        ...
        },
        {
            ...
            schema:     [
              ...
              
              {
                type:     'integer',
                name:     'width',
                label:    'Breedte van het veld (in pixels)'
              },
              {
                type:     'integer',
                name:     'height',
                label:    'Hoogte van het veld (in pixels) (alleen voor Textarea)'
              }
            ]
        },
    ...
    construct: function (self, options) {
        ...
        self.route('post', 'submit', (req, res) => {
            ...
            if (req.body.file && req.body.fileInputKey) {
                
                if (typeof req.body.file == 'object') {
                    bodyData[req.body.fileInputKey] = [];
                    req.body.file.forEach((bodyFile) => {
                        var file = JSON.parse(bodyFile);
                        bodyData[req.body.fileInputKey].push(file.url);
                    });
                    // Transform into an object
                    bodyData[req.body.fileInputKey] = {...bodyData[req.body.fileInputKey]};
                } else {
                    var file                        = JSON.parse(req.body.file);
                    bodyData[req.body.fileInputKey] = file.url;
                }
            }
