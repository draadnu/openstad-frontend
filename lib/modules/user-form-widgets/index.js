...
module.exports = {
    ...
    construct: function (self, options) {
        ...
        self.route('post', 'submit', (req, res) => {
            ...
            bodyData.formId = req.body.formId;
            ...
            body.submittedData.bc_email = req.body.data && req.body.emailField && req.body.data[req.body.emailField] ? req.body.data[req.body.emailField] : null;
