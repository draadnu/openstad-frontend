        ...
        self.play = function ($widget, data, options) {
            ...
            $widget.find('.user-form').each(function () {
                ...
                $form.find('input[type=radio]').on('change', function () {
                  ...
                  if ($(this).val() == 'anders namelijk' || $(this).val() == 'ik heb een ander idee' || $(this).val() == 'wel parkeerpaaltjes namelijk op deze plekken') {
                    var $next = $(this).closest('.form-group').nextAll('.form-group.hidden').first();
