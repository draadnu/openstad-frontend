    ...
    eventEmitter.emit('vote');
     ...
     rp(options)
      .then(function (response) {
        if (req.redirectUrl || req.query.redirectUrl || req.params.redirectUrl) {
          var redirectUrl = (req.redirectUrl || req.query.redirectUrl || req.params.redirectUrl);
          redirectUrl = Url.parse(redirectUrl);
