  ...
  construct: function(self, options) {
    ...
    self.prepend('body', function (req) {
      if (req.data.cookieConsent && req.data.global.tagmanager) {
        ...
        if (req.data.global.tagmanagerextra) {
  
          return '<!-- Google Tag Manager -->' + "\n" +
            '<noscript><iframe src="//www.googletagmanager.com/ns.html?id=' + req.data.global.tagmanager + req.data.global.tagmanagerextra + '" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>' + "\n" +
