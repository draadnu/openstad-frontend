...
const getIconUrl = function(status, theme, themes) {
    if (status == 'ACCEPTED') {
        return '/img/idea/flag-green.png';
    } else if (status == 'CLOSED'  || status == 'BUSY') {
...
const getMarkerUrlBasedOnTheme = function(status, flag) {
...
function getHref(ideaSlug, id) {
    var ids = [2767, 2772, 2773, 2774, 2776, 2790, 2927, 2919, 2918, 2914, 2906, 2905, 2904, 2898, 2897, 2896, 2889, 2881, 2877];
