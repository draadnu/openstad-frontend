...
function getHref(ideaSlug, id) {
    var ids = [2767, 2772, 2773, 2774, 2776, 2790, 2927, 2919, 2918, 2914, 2906, 2905, 2904, 2898, 2897, 2896, 2889, 2881, 2877, 3625,3628,3630,3642,3643,3645,3646,3648,3651,3657,3658,3659,3660,3820,3821,3579,3580,3585,3588,3589,3590,3592,3594];
...
function Marker(coordinates, status, url, endDate, theme, themes) {
    ...
    var url = getIconUrl(status, theme, themes);
    
    // Set different anchor for Bloemenbuurt
    if (url == '/uploads/attachments/ckiheda0101dttuinrnjd27fy-webp-net-resizeimage-2.full.png') {
        anchor = [11, 26];
    }
