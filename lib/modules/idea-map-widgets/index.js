  ...
  construct: function(self, options) {
    ...
    self.load = (req, widgets, callback) => {
        ...
        widgets.forEach((widget) => {
          ...
          if (req.data.global.siteId == 49 || req.data.global.siteId == 51) {
            widget.href = '/';
          } else if (req.data.global.siteId == 52) {
            widget.href = 'https://schipperskwartierbepaalt.denhaag.nl/';
          } else if (req.data.global.siteId == 50) {
            widget.href = 'https://komloosduinenbegroot.nl/';
          } else if (req.data.global.siteId == 57) {
            widget.href = 'https://benoordenhoutbegroot.denhaag.nl/';
          }
        });
