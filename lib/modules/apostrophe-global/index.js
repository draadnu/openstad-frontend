...
module.exports = {
  addFields: [
    ...
    {
      type: 'string',
      name: 'tagmanagerextra',
      label: 'Google Tag Manager URL addition (i.e. &gtm_auth=CODE&gtm_preview=env-1)'
    },
    {
      type: 'boolean',
      name: 'showAdminBar',
    ...
    },
    {
      type: 'boolean',
      name: 'showLastName',
      label: 'Show last name for users',
      def: true,
    },
    {
      name: 'siteLogo',
    ...
    options.arrangeFields = (options.arrangeFields || []).concat([
      {
        name: 'general',
        label: 'Algemeen',
        fields: ['siteTitle', 'hideSiteTitle', 'analytics', 'tagmanager', 'tagmanagerextra', 'showAdminBar', 'fbImage', 'favicon', 'showLastName']
      },
      {
        name: 'api',
